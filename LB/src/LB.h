...
namespace LB {
    ...
    enum class InstructionType{assign, assign_operation, call, call_assign, return_empty, return_value, br_unconditional, if_instruction, while_instruction, init_var, assign_load_array, assign_store_array, assign_new_array, assign_new_tuple, assign_length, label, print, continue_instruction, break_instruction, scope_begin};
